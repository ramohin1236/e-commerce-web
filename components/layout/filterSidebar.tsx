...
export default function FilterSidebar({
  ...
  return (
    <div className="bg-white w-full max-w-[270px] border-r border-gray-300 shrink-0 pr-6">
      {/* Header */}
      <div className="mb-6">
         <input
                type="text"
                ...
                className="w-full px-2 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-pink-500"
              />
      </div>
